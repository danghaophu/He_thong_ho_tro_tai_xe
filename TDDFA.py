...
from my_utils.io import _load
from my_utils.functions import (
    crop_img, parse_roi_box_from_bbox, parse_roi_box_from_landmark,
)
from my_utils.tddfa_util import (
...
class TDDFA(object):
    ...
    def __init__(self, **kvs):
        ...
        # load BFM
        self.bfm = BFMModel(
            bfm_fp=kvs.get('bfm_fp', make_abs_path('E:\do an tot nghiep\SafeDriveVision-master\SafeDriveVision-master\configs\bfm_noneck_v3.pkl')),
        ...
        model = getattr(my_models, kvs.get('arch'))(
