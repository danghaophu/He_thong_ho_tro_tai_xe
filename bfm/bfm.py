...
class BFMModel(object):
    def __init__(self, bfm_fp, shape_dim=40, exp_dim=10):
        ...
        if osp.split(bfm_fp)[-1] == r'E:\do an tot nghiep\SafeDriveVision-master\SafeDriveVision-master\configs\bfm_noneck_v3.pkl':
        ...
        self.keypoints = bfm.get('keypoints').astype(np.int_)  # fix bug
